...
fn test_null_default_in_schema() {
    ...
    let tool = tools
        .iter()
        .find(|t| t.name == "test_null_default")
        .unwrap();
    ...
    assert_eq!(
        schema["properties"]["nickname"]["default"],
...
fn test_int_default_str_in_schema() {
    ...
    let tool = tools
        .iter()
        .find(|t| t.name == "test_int_default_str")
        .unwrap();
...
fn test_float_default_str_in_schema() {
    ...
    let tool = tools
        .iter()
        .find(|t| t.name == "test_float_default_str")
        .unwrap();
...
fn test_float_default_in_schema() {
    ...
    let tool = tools
        .iter()
        .find(|t| t.name == "test_float_default")
        .unwrap();
...
fn test_bool_default_str_in_schema() {
    ...
    let tool = tools
        .iter()
        .find(|t| t.name == "test_bool_default_str")
        .unwrap();
...
fn test_bool_default_in_schema() {
    ...
    let tool = tools
        .iter()
        .find(|t| t.name == "test_bool_default")
        .unwrap();
...
fn test_array_default_str_in_schema() {
    ...
    let tool = tools
        .iter()
        .find(|t| t.name == "test_array_default_str")
        .unwrap();
...
fn test_array_default_in_schema() {
    ...
    let tool = tools
        .iter()
        .find(|t| t.name == "test_array_default")
        .unwrap();
